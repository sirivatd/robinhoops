...
players_data.each do |player|
    ...
    image_url = 'http://team4096.org/site/assets/files/8881/profile-picture_man.400x400.png' if res.body == "Sorry, that player was not found. Please check the spelling."
    twitter_sentiment = 0
